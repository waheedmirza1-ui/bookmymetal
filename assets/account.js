...
(() => {
  ...
  usePassword?.addEventListener('click', () => { primaryPanel.hidden = true; registerPanel.hidden = true; registerPanel.style.display = 'none'; loginPanel.removeAttribute('hidden'); loginPanel.style.display = 'block'; document.body.classList.add('password-login'); document.querySelector('#login-panel input')?.focus(); });
  createPasswordAccount?.addEventListener('click', () => { primaryPanel.hidden = true; loginPanel.hidden = true; loginPanel.style.display = 'none'; registerPanel.removeAttribute('hidden'); registerPanel.style.display = 'block'; document.body.classList.remove('password-login'); document.body.classList.add('password-register'); document.querySelector('#register-panel input')?.focus(); });
